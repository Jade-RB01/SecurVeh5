...
function CalcularTarifa(nombreCliente, apellidosCliente, marcaVehiculo, placaVehiculo, tipoVehiculo, horas) {
...
Total a pagar: S/ ${total.toFixed(2)}
    `;
    // Devuelve la cadena para que Ejecucion Tarifa la imprima
    return resultado;
}
